...
# time spark-submit --packages com.amazonaws:aws-java-sdk-pom:1.10.34,org.apache.hadoop:hadoop-aws:2.7.2,databricks:spark-deep-learning:1.5.0-spark2.4-s_2.11 P8_script_s3.py 
...
## Configurations ...
# put the credential file on the EC2 or on the master EC2 of the EMR cluster
import os
